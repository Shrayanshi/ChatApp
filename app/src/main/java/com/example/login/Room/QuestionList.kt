...
@Composable
fun QuestionList(questionViewModel: QuestionViewModel = viewModel(), viewModel: LoadingViewModel) {
...
//            }
            ...
            if (expandedQuestion.value == question) {
                question.subQuestions.forEach { subQuestion ->
                    viewModel.chatTitle.value = question.title
                    SubQuestion(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                if (expandedSubQuestion) {
                    subQuestion.subQuestions?.forEach { nestedSubQuestion ->
                        viewModel.chatTitle.value = subQuestion.question
                        SubQuestion(
